...
class MonkeyBunch:
    ...
    def add_monkey(self, monkey_num, starting_items, wl_op, wl_op_txt, test_op, divider, test_op_txt, throw_to_false,
                   throw_to_true, throw_to):
        new_monkey = Monkey(monkey_num, starting_items, wl_op, wl_op_txt, test_op, divider, test_op_txt, throw_to_false,
...
class Monkey:
    def __init__(self, monkey_num, starting_items, wl_op, wl_op_txt, test_op, divider, test_op_txt, throw_to_false,
    ...
    def inspect_item(self, idx):
        ...
        if self.test_op(wlevel):
            countx = 0
            while wlevel_bored % self.divider == 0:
                countx += 1
                wlevel_bored = wlevel_bored // self.divider
            if countx > 1:
                print(' wacht')
